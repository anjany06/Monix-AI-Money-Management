    ...
    for (const budget of budgets) {
      ...
      await step.run(`check-budget-${budget.id}`, async () => {
        ...
        if (
          ...
          console.log(`🚨 Budget alert triggered for ${budget.user.name}`);
...
async function generateFinancialInsights(stats, month) {
  ...
  try {
    ...
    return [
      ...
      "Consider reviewing your spending habits for potential savings.",
      "Keep up the good work on your income generation!",
    ];
  }
}
